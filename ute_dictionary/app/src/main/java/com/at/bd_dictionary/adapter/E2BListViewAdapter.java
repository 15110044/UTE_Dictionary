...
public class E2BListViewAdapter extends BaseAdapter implements Filterable{
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        holder.eng_word.setText(wordLists.get(position).getTu());
        holder.bang_word.setText(wordLists.get(position).getNghia());
                ...
                tts = new TextToSpeech(context, new TextToSpeech.OnInitListener() {
                    ...
                    public void onInit(int status) {
                        if (status == TextToSpeech.SUCCESS){
                            ...
                            String toSpeak = word_eng.getMp3();
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint != null && constraint.length() > 0) {
                ...
                for (int i = 0; i < searchWorld.size(); i++) {
                    if ((searchWorld.get(i).getTu().toLowerCase()).contains(constraint.toString().toLowerCase())) {
    ...
    public String getFonts() {
        ...
        Log.d("Disctionary adapter", orginalFonts.toString());
        return orginalFonts;
    }
}